...
class Person:
    ...
    def printPersonData(self):
        print("Person.printPersonData: ", self.name, self.surname, 
              self.city)
...
class Manager(Employee):
    ...
    def printManagerData(self):
        print("Manager data :", self.name, self.surname, self.city, self.companyName,
              self.salary, self.department)

print("----------------------")
manager1 = Manager("Ania", "Fees", "Gda", "CodeBox", 12000, "IT")
